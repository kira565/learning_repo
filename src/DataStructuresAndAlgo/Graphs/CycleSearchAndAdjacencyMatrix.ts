...
export const findCycleGraph = new Graph(["0", "1", "2", "3", "4", "5", "6"]);
findCycleGraph.addEdge("0", "1");
findCycleGraph.addEdge("1", "2");
findCycleGraph.addEdge("1", "5");
findCycleGraph.addEdge("2", "3");
findCycleGraph.addEdge("2", "4");
findCycleGraph.addEdge("5", "6");
findCycleGraph.addEdge("6", "0");
