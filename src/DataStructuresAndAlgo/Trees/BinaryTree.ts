...
export class BinaryTree<T> {
  ...
  inOrderTraversal(action: (val: T) => any, isRecursive = true) {
  ...
  inorderRecursive(handlerFunction: (val: T) => any) {
    this._inorderInternal(this.root, handlerFunction);
  }

  *inorderStack(head: BinaryTreeNode<T> | null) {
  ...
  _insertNode(currentNode: BinaryTreeNode<T>, newNode: BinaryTreeNode<T>) {
  ...
  _findMinElement(currentNode: BinaryTreeNode<T>): BinaryTreeNode<T> {
  ...
  _deleteNode(currentNode: BinaryTreeNode<T>, itemValue: T) {
